#!/bin/bash
#SBATCH -e /data/users3/fborhan1/MISA-pytorch/slurm_logs/error%A-%a.err
#SBATCH -o /data/users3/fborhan1/MISA-pytorch/slurm_logs/out%A-%a.out
#SBATCH --mail-type=ALL
#SBATCH --mail-user=fborhan1@student.gsu.edu
...
lrs=(0.100 0.100 0.001 0.100 0.001 0.001)

batch_size=(100 316 1000 100 1000 100)
patience=(10 10 100 100 10 100)

#Adam optimizer parameters
foreach=(0 1 0 1 0 1)
fused=(1 1 0 0 0 1)
beta1=(0.65 0.95 0.65 0.95 0.95 0.65)
beta2=(0.99 0.81 0.81 0.99 0.99 0.90)
